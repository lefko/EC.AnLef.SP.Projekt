...
using EC.AnLef.SP.Projekt.Code;
using Microsoft.SharePoint;
using Microsoft.SharePoint.Security;

namespace EC.AnLef.SP.Projekt.Features.EC.AnLef.AddList
{
    /// <summary>
    ...
    [Guid("6d8b5cf2-8b39-4c18-9836-b4effe0f6a3f")]
    public class ECAnLefEventReceiver : SPFeatureReceiver
    {
        ...
        public override void FeatureActivated(SPFeatureReceiverProperties properties)
        {
            try
            {
                ...
                myCustomers.Fields.Add("CustomerWebsite", SPFieldType.Text, true);
